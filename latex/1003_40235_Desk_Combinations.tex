...
\begin{table}[h]
  ...
  \textbf{Class} & 1003 & {\qquad} &\textbf{Schedule} & Wednesday 3:00pm - 5:00pm \\
  \textbf{Section} & 40235 & {\qquad} & \textbf{Semester} & Fall 2015 \\
  \textbf{Lab} & 141 & {\qquad} & \textbf{Instructor} & Sharon Cruse \\
  \end{tabular}
\end{table}
 \vspace{0.5in}
